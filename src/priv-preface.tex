...
\begin{itemize}
  ...
  \item Describe the behavior of address-translation caches a little more explicitly and clearly
  \item Allow for speculative updates of page table entry A bits
  \item Slightly relax the atomicity requirement for A and D bit updates performed by the implementation
