...
\newcommand{\privrev}{1.12-draft-VM-TASKGROUP}
\newcommand{\privmonthyear}{September 2020}
...
\textcolor{red}{\bf THIS IS A WORKING COPY BEING USED BY THE VIRTUAL MEMORY TASK GROUP.  ALL CONTENT IS SUBJECT TO CHANGE.}
...
\textcolor{red}{Authors for virtual memory components to be added!}
